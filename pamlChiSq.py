...
for i in ChiSq_dict.keys():
    ...
    # try:
    print(M3_M0_pvalue = cdf_chi2(M3_M0_df, M3_M0_chiSq))
    # except:
        #  M3_M0_pvalue = None
    ...
    # try:
    print(M2_M1_pvalue = cdf_chi2(M2_M1_df, M2_M1_chiSq))
    # except:
        #  M2_M1_pvalue = None
    ...
    # try:
    print(M8_M7_pvalue = cdf_chi2(M8_M7_df, M8_M7_chiSq))
    # except:
        #  M8_M7_pvalue = None
    ...
    # try:
    print(M8_M8a_pvalue = cdf_chi2(M8_M8a_df, M8_M8a_chiSq))
    # except:
        #  M8_M8a_pvalue = None
